            ...
            switch(ch){
                ...
                while(!admin_exit){
                    ...
                    switch(ach){
                        ...
                        break;
                        case 2:books.remove(rembooks(books));
                        break;
                        case 3:
                        ...
                        break;
                        case 4:for(int i=0;i<books.size();i++){
                ...
                if(ul!=-1){
                    ...
                    while(!user_exit){
                        ...
                        switch(uc){
                            ...
                            break;
                            case 2:int rb = removefromcart(users.get(ul).cart);
                            if(rb!=-1){
                                int f=-1;
                                for(int i=0;i<books.size();i++){
                            ...
                            break;
                            case 3:System.out.println("Your balance is "+users.get(ul).money);
                            break;
